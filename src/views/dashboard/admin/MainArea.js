...
export default function MainArea() {
  ...
  return (
    <div className="w-4/5 h-full bg-slate-100 flex flex-col">
      <AddEmployee open={open} handleOpen={handleOpen} type={type} employee={employee} />
      <DeleteEmployeeDialog isOpen={isOpen} handleOpen={handleDeleteOpen} employee={employee}/>
                          ...
                          employees.map((emp, i) => (
                            <tr
                             className="border-b transition duration-300 ease-in-out hover:bg-yellow-400 dark:border-neutral-500 dark:hover:bg-neutral-600">
                              ...
                              <td className="whitespace-nowrap px-6 py-4">
                                <IconButton onClick={()=>{handleOpen("edit");setEmployee(emp)}}>
                                  <Edit color="primary"/>
                                </IconButton>
                                <IconButton onClick={()=>{
                                  handleDeleteOpen();
